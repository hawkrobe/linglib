...
[fiengo-1987] [huang-1982b] [shen-huang-2026]
...
[fiengo-1987] ties specificity to Heim's familiarity theory of
...
[cheng-sybesma-1999] use "specificity" differently — for them it is
...
[shen-huang-2026] §2.2 argue that the extraction-relevant notion is
...
1. Definite island effects in wh-movement (English: [chomsky-1973])
2. Definite island effects in wh-in-situ (Mandarin Chinese:
   [huang-1982b], [shen-huang-2026])
3. Wh-indefinite sensitivity to demonstratives in Chinese
   ([li-1992], [shen-huang-2026] Experiment 3)
4. Island effects for relativization ([ross-1967])
5. Island effects for unselective binding ([li-1992])
...
[fiengo-1987]: "already familiar at the current stage of the
conversation."
...
not [cheng-sybesma-1999]'s predicate-dependent specificity. -/
...
inductive ExternalOperator where
  ...
  /-- Existential closure binds a wh-indefinite
      ([li-1992]: wh-phrases as indefinites) -/
  | existentialClosure
...
Specificity Condition.
    ...
    [shen-huang-2026]: this condition applies uniformly to both
...
-- ============================================================================
-- §3. Interaction with wh-indefinites ([li-1992])
-- ============================================================================

/-- In Chinese, wh-phrases can be interpreted as indefinites ("something",
"someone") when bound by an existential closure operator. [li-1992]
...
[shen-huang-2026] Experiment 3 confirms this contrast experimentally
