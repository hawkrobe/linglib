...
surface form, the sub-class, the Vendler class the adverbial selects ([vendler-1957]), and the
polarity and licensing requirements. Paper-specific apparatus, such as [rouillard-2026]'s labels,
the domain-widening profile of [iatridou-zeijlstra-2021] or the perfect-level classification of
...
and negation. The same preposition as `inTelic`, told apart by position and licensing
environment. -/
