...
namespace Fragments.Bulgarian.VerbalPrefixes

/-- Bulgarian grammatical aspect. -/
inductive Aspect
  | perfective
  | imperfective
...
/-- Aspectual subtypes for the superlexical class
    (@cite{svenonius-2004} §3). The same six categories used in the
    Russian and Polish fragments. -/
...
/-- @cite{svenonius-2004}'s lexical / superlexical split. -/
...
end Fragments.Bulgarian.VerbalPrefixes
