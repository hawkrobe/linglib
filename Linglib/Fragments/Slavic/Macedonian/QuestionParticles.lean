...
ex. 32), or by the verb-attached *li*; the mirative *zar* of the cross-Slavic RAZVE family conveys
...
/-- ли li is the polar question particle enclitic on the fronted verb, a
less formal quiz-felicitous strategy whose negated form conveys positive
epistemic bias ([simik-2024] ex. 32b); reported to convey surprise or a
negative answer expectation, unlike Bulgarian and Russian *li*
([simik-2024] §4.2.5). -/
