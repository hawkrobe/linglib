...
AF, so the marked subject is A, not S. Extraction of a low adjunct may
add the fronting particle *wi* to the verbal complex; in this variety
the particle is optional ([mendes-ranero-2021]).
...
*-ö* or *-n*, with Set A suppressed, [erlewine-2016]); low-adjunct
extraction licenses *wi* on the verbal complex ([mendes-ranero-2021]);
