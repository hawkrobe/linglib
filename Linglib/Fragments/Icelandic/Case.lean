...
Icelandic has **4 morphological cases**: NOM, ACC, DAT, GEN. The signature
phenomenon is **quirky case**: non-nominative subjects (DAT, ACC, rarely GEN)
that pass virtually all standard subject diagnostics except verb agreement.
...
theorem inventory_valid :
    validInventory caseInventory = true := by native_decide
...
-- ============================================================================
-- § 3: Dyadic Verb Data — Productive Patterns
-- ============================================================================

-- § 3.1: NOM-ACC (NA) — default, most common
...
-- § 3.4: DAT-NOM (DN) — quirky dative subject, common
...
-- § 3.5: ACC-ACC (AA) — quirky accusative subject, not very stable
...
-- ============================================================================
-- § 3b: Rare / Marginal Dyadic Patterns
-- ============================================================================
...
-- § 9.2: Quirky subject identification
...
-- § 9.8: Cross-reference with -st fragment
