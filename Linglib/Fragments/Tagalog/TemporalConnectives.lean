...
This morphological evidence supports [rett-2020a]'s ambiguity analysis:
...
-- ============================================================================
-- § 2: *bago* ('before') Entries ([rett-2020a], ex. 12; [dell-1983])
-- ============================================================================

/-- *bago* + PFV.NEUT → before-start (≺ initial).
    [rett-2020a] ex. (12a): "She left before he swept the floor" with neutral
...
/-- *bago* + AIA → before-finish (≺ final).
    [rett-2020a] ex. (12b): "She left before he swept the floor" with AIA
