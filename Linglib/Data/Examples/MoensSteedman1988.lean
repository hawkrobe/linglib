...
def when_state : LinguisticExample :=
  { id := "moenssteedman1988_when_state"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "When John knew the answer, he raised his hand."
...
def when_activity : LinguisticExample :=
  { id := "moenssteedman1988_when_activity"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "When John ran, the crowd cheered."
...
def when_accomplishment : LinguisticExample :=
  { id := "moenssteedman1988_when_accomplishment"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "When John built the house, he sold it."
...
def when_achievement : LinguisticExample :=
  { id := "moenssteedman1988_when_achievement"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "When John arrived, Mary left."
