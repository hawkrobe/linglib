...
def gs2025_t2_honey : LinguisticExample :=
  { id := "gs2025_t2_honey"
    ...
    comment := "Brit Bennett, The vanishing half; progressive -ing on a PAL in a verb slot."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_t2_welcome : LinguisticExample :=
  { id := "gs2025_t2_welcome"
    ...
    comment := "COCA; the PAL quotes the immediately preceding turn in an interdiction."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_t3_jespersen : LinguisticExample :=
  { id := "gs2025_t3_jespersen"
    ...
    comment := "Quoted from Jespersen (1924:96); plural -s on a PAL in a noun slot."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_t3_diy : LinguisticExample :=
  { id := "gs2025_t3_diy"
    ...
    comment := "ABC News; agentive -er and plural -s on a PAL in a noun slot."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_t3_nyt : LinguisticExample :=
  { id := "gs2025_t3_nyt"
    ...
    readings := []
    paperFeatures := [("position", "verb"), ("inflection", "gerund")]
    comment := "New York Times, 19 June 2015; gerund -ing on PALs in verb slots."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_8a : LinguisticExample :=
  { id := "gs2025_8a"
    ...
    translation := "I-buy-your-car card"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("hostFrame", "compound")]
    comment := "German phrasal compound, orthographically presented; the paper's glosses."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_15a : LinguisticExample :=
  { id := "gs2025_15a"
    ...
    translation := "laugh-or-I-shoot humor"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("hostFrame", "compound")]
    comment := "Dutch phrasal compound, orthographically presented; the paper's glosses."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_15b : LinguisticExample :=
  { id := "gs2025_15b"
    ...
    translation := "god-is-dead theology"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("hostFrame", "compound")]
    comment := "Afrikaans phrasal compound, orthographically presented as in the source; the paper's glosses."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_15c : LinguisticExample :=
  { id := "gs2025_15c"
    ...
    translation := "\"show your underwear\" game"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("hostFrame", "compound")]
    comment := "Turkish; the compound marker on the head noun signals the compound-like frame. Source's parsing, glosses, and translation."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_16b : LinguisticExample :=
  { id := "gs2025_16b"
    ...
    translation := "an if-you-know-you-know thing"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("hostFrame", "preposition complement")]
    comment := "Modern Hebrew, Twitter; the PAL is the complement of the preposition ʃel."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_17b : LinguisticExample :=
  { id := "gs2025_17b"
    ...
    translation := "I'm excited to the level of \"I'm gonna start crying here in a minute\""
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("hostFrame", "preposition complement")]
    comment := "Modern Hebrew; the PAL is the complement of the preposition ʃel."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def gs2025_18b : LinguisticExample :=
  { id := "gs2025_18b"
    ...
    translation := "the pleasant climate of \"I help you, you help me, and everything is good\""
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("hostFrame", "preposition complement")]
    comment := "Brazilian Portuguese, NOW corpus; the PAL is the complement of the preposition de."
    metaLanguage := "stan1293"
    lgrConformance := "" }
