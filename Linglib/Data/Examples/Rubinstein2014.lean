...
def nr_better : LinguisticExample :=
  { id := "rubinstein2014_nr_better"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "I don't think you better leave."
    context := "Embedded under 'I don't think', testing the lower-negation (neg-raising) reading."
    judgment := .acceptable
    alternatives := []
    readings := [("lowerNeg", .acceptable)]
...
def nr_adif : LinguisticExample :=
  { id := "rubinstein2014_nr_adif"
    ...
    translation := "(I'm astonished that) young Chinese these days don't think it would be better if things were different."
...
def compositional_deberia : LinguisticExample :=
  { id := "rubinstein2014_compositional_deberia"
    ...
    translation := "I ought to do the dishes but I am not obliged to."
...
def test1_carix : LinguisticExample :=
  { id := "rubinstein2014_test1_carix"
    ...
    translation := "?He needs to do the dishes, but he doesn't have to."
...
def nr_carix : LinguisticExample :=
  { id := "rubinstein2014_nr_carix"
    ...
    translation := "I don't think you should be here."
