...
def ex29c : LinguisticExample :=
  { id := "lahiri1998_ex29c"
    ...
    comment := "Object NPI in the scope of a prohibition verb (4.5). The rokaa 'prevented' variant carries the paper's (?) diacritic."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex29d : LinguisticExample :=
  { id := "lahiri1998_ex29d"
    ...
    comment := "The matrix object NPI is outside the DE scope of the prohibition verb (4.5); starred with both manaa kiyaa 'prohibited' and rokaa 'prevented'."
    metaLanguage := "stan1293"
    lgrConformance := "" }
