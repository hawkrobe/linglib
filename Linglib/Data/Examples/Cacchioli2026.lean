...
def ex_5b : LinguisticExample :=
  { id := "cacchioli2026_5b"
    ...
    translation := "I do not play with my cat."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("clause", "root"), ("neg_suffix", "present")]
    comment := "Negative counterpart of (5a) mɨs dɨm-ay ji-ts'awɛt 'I play with my cat'."
...
def ex_12a : LinguisticExample :=
  { id := "cacchioli2026_12a"
    ...
    translation := "The books that I do not read are in the cabinet."
    context := ""
    judgment := .acceptable
    ...
    comment := "(12b) suffix alone and (12c) prefix plus suffix are both ungrammatical in a relative clause; ʔaj- surfaces as ɛj- after zɨ-."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def ex_14 : LinguisticExample :=
  { id := "cacchioli2026_14"
    ...
    translation := "Kidane seems to not read books."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_15 : LinguisticExample :=
  { id := "cacchioli2026_15"
    ...
    translation := "If he doesn't leave, I'll cry."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_16 : LinguisticExample :=
  { id := "cacchioli2026_16"
    ...
    translation := "Aman asked me what I don't like."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_20 : LinguisticExample :=
  { id := "cacchioli2026_20"
    ...
    translation := "I tried not to cry."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_21 : LinguisticExample :=
  { id := "cacchioli2026_21"
    ...
    translation := "He ordered the chicken not to fly."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_22 : LinguisticExample :=
  { id := "cacchioli2026_22"
    ...
    translation := "We wanted the woman not to leave."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_23 : LinguisticExample :=
  { id := "cacchioli2026_23"
    ...
    translation := "I walked slowly to not wake up the lion."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_24 : LinguisticExample :=
  { id := "cacchioli2026_24"
    ...
    translation := "Tewelde will not eat vegetables."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("clause", "future"), ("neg_suffix", "present")]
    comment := "The negative future: ʔaj- precedes kɨ- and the suffix is present."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def ex_25 : LinguisticExample :=
  { id := "cacchioli2026_25"
    ...
    translation := "I explained that a chicken does not fly."
    context := ""
    judgment := .acceptable
    ...
    comment := "Printed as ʔaj-Ø-nɨfɨri-*(n): the suffix is obligatory."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def ex_29 : LinguisticExample :=
  { id := "cacchioli2026_29"
    ...
    translation := "I know that he often goes to the cinema."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_30 : LinguisticExample :=
  { id := "cacchioli2026_30"
    ...
    translation := "I forgot that he comes at noon."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_31 : LinguisticExample :=
  { id := "cacchioli2026_31"
    ...
    translation := "He admits that he likes her."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_32 : LinguisticExample :=
  { id := "cacchioli2026_32"
    ...
    translation := "I accept that he likes spiders."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_33 : LinguisticExample :=
  { id := "cacchioli2026_33"
    ...
    translation := "Aman thinks that Tesfay sells books."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_34 : LinguisticExample :=
  { id := "cacchioli2026_34"
    ...
    translation := "Aman believes that Tesfay sells books."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_35 : LinguisticExample :=
  { id := "cacchioli2026_35"
    ...
    translation := "I suspect that he steals money."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_51 : LinguisticExample :=
  { id := "cacchioli2026_51"
    ...
    translation := "I heard that she became a painter."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_52a : LinguisticExample :=
  { id := "cacchioli2026_52a"
    ...
    translation := "I saw that they got married."
    context := ""
    judgment := .acceptable
    ...
    comment := "ʔɨlu is excluded with perception verbs."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def ex_54 : LinguisticExample :=
  { id := "cacchioli2026_54"
    ...
    translation := "Tesfay dreamt that Aman bought a dog."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_55 : LinguisticExample :=
  { id := "cacchioli2026_55"
    ...
    translation := "I read that cats eat mice."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
