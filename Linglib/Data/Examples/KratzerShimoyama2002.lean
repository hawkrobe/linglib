...
def ex23a : LinguisticExample :=
  { id := "kratzershimoyama2002_ex23a"
    ...
    comment := "Multiple question with the second wh-phrase in situ, the intervener preceding it."
...
def ex24a : LinguisticExample :=
  { id := "kratzershimoyama2002_ex24a"
    ...
    comment := "The in-situ wh-phrase scrambled over the intervener."
    metaLanguage := "stan1293"
    lgrConformance := "WORD_ALIGNED" }
...
def ex12 : LinguisticExample :=
  { id := "kratzershimoyama2002_ex12"
    ...
    comment := "Under a negative quantifier the distribution requirement disappears."
    metaLanguage := "stan1293"
    lgrConformance := "WORD_ALIGNED" }
...
def ex13 : LinguisticExample :=
  { id := "kratzershimoyama2002_ex13"
    ...
    comment := "Under a downward-entailing verb the distribution requirement disappears."
    metaLanguage := "stan1293"
    lgrConformance := "WORD_ALIGNED" }
...
def ex21 : LinguisticExample :=
  { id := "kratzershimoyama2002_ex21"
    ...
    comment := "With irgend stressed the sentence has the reading 'I didn't read just ANYthing' (footnote 8)."
    metaLanguage := "stan1293"
    lgrConformance := "WORD_ALIGNED" }
...
def ex22 : LinguisticExample :=
  { id := "kratzershimoyama2002_ex22"
    ...
    comment := "In the embedded polar question irgendein has a single reading and no free-choice effect."
    metaLanguage := "stan1293"
    lgrConformance := "WORD_ALIGNED" }
