...
def ex_26a : LinguisticExample :=
  { id := "aghajeretic2026_26a"
    source := ⟨"weingartz-hohaus-2024", ""⟩
    reportedIn := some ⟨"agha-jeretic-2026", "(26a)"⟩
    language := "afri1274"
...
def ex_28a : LinguisticExample :=
  { id := "aghajeretic2026_28a"
    source := ⟨"weingartz-hohaus-2024", ""⟩
    reportedIn := some ⟨"agha-jeretic-2026", "(28a)"⟩
    language := "samo1305"
...
def ex_44 : LinguisticExample :=
  { id := "aghajeretic2026_44"
    ...
    comment := "Marked # in the context: the intended 'You don't have to go' is unavailable, and the actual 'You can't go' is weird there."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_51 : LinguisticExample :=
  { id := "aghajeretic2026_51"
    ...
    comment := "The necessity reading of får is shown by (52)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_52 : LinguisticExample :=
  { id := "aghajeretic2026_52"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Isac has to pay a fine."
    ...
    paperFeatures := [("modal", "får"), ("environment", "unembedded")]
    comment := "The necessity reading of får unembedded."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_55 : LinguisticExample :=
  { id := "aghajeretic2026_55"
    ...
    comment := "The necessity reading of får in a conditional antecedent is shown by (56)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_56 : LinguisticExample :=
  { id := "aghajeretic2026_56"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "If Maria has to pay a fine, she will be unhappy."
    context := "Maria took the train without paying and is worried about getting caught."
    judgment := .acceptable
    alternatives := []
    readings := [("necessity", .acceptable)]
    paperFeatures := [("modal", "får"), ("environment", "other DE")]
    comment := "The necessity reading of får in a conditional antecedent."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_79a : LinguisticExample :=
  { id := "aghajeretic2026_79a"
    ...
    comment := "The chapter calls the strong reading, that hard work never results in success, the most salient and preferred one."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_85a : LinguisticExample :=
  { id := "aghajeretic2026_85a"
    ...
    comment := "The chapter reports the reading that babies never eat arugula as the salient one."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_91a : LinguisticExample :=
  { id := "aghajeretic2026_91a"
    ...
    comment := "The generalization (90) is Hackl and Nissenbaum's; the sentence is the chapter's."
    metaLanguage := "stan1293"
    lgrConformance := "" }
