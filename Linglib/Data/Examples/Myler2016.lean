...
def concrete_attrA : LinguisticExample :=
  { id := "myler2016_concrete_attrA"
    ...
    comment := "Attributive possession, column A of (18) (from Myler, Sigurðsson & Wood 2014); # is recorded as questionable, % as marginal."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def concrete_attrB : LinguisticExample :=
  { id := "myler2016_concrete_attrB"
    ...
    comment := "Attributive possession, column B of (18) (from Myler, Sigurðsson & Wood 2014); # is recorded as questionable, % as marginal."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def concrete_attrC : LinguisticExample :=
  { id := "myler2016_concrete_attrC"
    ...
    comment := "Attributive possession, column C of (18) (from Myler, Sigurðsson & Wood 2014); # is recorded as questionable, % as marginal."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
