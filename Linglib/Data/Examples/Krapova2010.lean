...
def ex_57a : LinguisticExample :=
  { id := "krapova2010_57a"
    ...
    readings := []
    paperFeatures := [("verb", "săžaljavam"), ("complementizer", "deto"), ("diagnostic", "projection"), ("family", "negation"), ("projective", "yes"), ("person", "1")]
...
def ex_57b : LinguisticExample :=
  { id := "krapova2010_57b"
    ...
    readings := []
    paperFeatures := [("verb", "vinoven săm"), ("complementizer", "deto"), ("diagnostic", "projection"), ("family", "question"), ("projective", "yes"), ("person", "1")]
