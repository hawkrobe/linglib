...
def ex_57a : LinguisticExample :=
  { id := "krapova2010_57a"
    ...
    readings := []
    paperFeatures := [("verb", "săžaljavam"), ("complementizer", "deto"), ("diagnostic", "projection"), ("environment", "negation"), ("inference", "yes")]
...
def ex_57b : LinguisticExample :=
  { id := "krapova2010_57b"
    ...
    readings := []
    paperFeatures := [("verb", "vinoven săm"), ("complementizer", "deto"), ("diagnostic", "projection"), ("environment", "question"), ("inference", "yes")]
...
def ex_57c : LinguisticExample :=
  { id := "krapova2010_57c"
    ...
    readings := []
    paperFeatures := [("verb", "săžaljavam"), ("complementizer", "deto"), ("diagnostic", "projection"), ("environment", "cancellation"), ("inference", "yes")]
...
def fn46i : LinguisticExample :=
  { id := "krapova2010_fn46i"
    ...
    readings := []
    paperFeatures := [("verb", "văzmuštavam se"), ("complementizer", "če"), ("diagnostic", "projection"), ("environment", "cancellation"), ("inference", "yes")]
