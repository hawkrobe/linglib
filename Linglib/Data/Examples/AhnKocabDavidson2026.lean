...
def ex9 : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex9"
    ...
    comment := "Accepted by all three signers (3/3). One referent; the final verb is unmodified."
...
def ex10a : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex10a"
    ...
    comment := "Accepted by one of three signers (1/3). Two referents, no loci established, unmodified verb."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex10b : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex10b"
    ...
    comment := "3/3. Two referents established in loci; the verb is signed at the agent's locus."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex11a : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex11a"
    ...
    comment := "Rejected by all three signers (0/3). No loci and no context making the agent salient."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex11b : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex11b"
    ...
    comment := "3/3. Loci marked and the verb moves between them."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex11c : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex11c"
    ...
    comment := "3/3: context suffices. The surrounding context renders the agent salient; the same unmodified verb as in (11a)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex18 : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex18"
    ...
    readings := []
    paperFeatures := [("locus", "false"), ("resolved", "true"), ("condition", "consultant"), ("verb", "DANCE")]
    comment := "3/3 for both the null argument and the bare noun. One referent; a null argument and a bare noun are both accepted."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex19 : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex19"
    ...
    comment := "3/3, but considered redundant and dispreferred relative to the null argument. One referent with locus marking."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex20 : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex20"
    ...
    readings := []
    paperFeatures := [("locus", "false"), ("resolved", "true"), ("condition", "consultant"), ("verb", "DANCE")]
    comment := "Bare noun accepted 3/3; the null-argument version was rejected by two of three signers. Two referents; the bare noun BOY disambiguates without a locus, the null argument does not."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex20null : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex20null"
    ...
    readings := []
    paperFeatures := [("locus", "false"), ("resolved", "false"), ("condition", "consultant"), ("verb", "DANCE")]
    comment := "Rejected by two of three signers. Two referents, null argument, no loci."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex21 : LinguisticExample :=
  { id := "ahnkocabdavidson2026_ex21"
    ...
    readings := []
    paperFeatures := [("locus", "true"), ("resolved", "false"), ("condition", "consultant"), ("verb", "DANCE")]
    comment := "3/3, with no dispreference for marking the loci. Two referents established in different loci."
    metaLanguage := "stan1293"
    lgrConformance := "" }
