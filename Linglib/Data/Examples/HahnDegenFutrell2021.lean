...
def so1 : LinguisticExample :=
  { id := "hahndegenfutrell2021_so1"
    ...
    translation := "(Thabo) is buying it (the food)"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("section", "5.2"), ("phenomenon", "morphemeOrder")]
    comment := "The verb of Demuth's example; Demuth's glosses carry the noun class of the subject and object markers, dropped here. The subject marker carries the present-tense -a of a verb without a lexical argument."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def so2 : LinguisticExample :=
  { id := "hahndegenfutrell2021_so2"
    ...
    translation := "(Thabo) cooks (food for Mpho)"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("section", "5.2"), ("phenomenon", "morphemeOrder")]
    comment := "The verb of Demuth's example; Demuth's glosses carry the noun class of the subject and object markers, dropped here."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def so3 : LinguisticExample :=
  { id := "hahndegenfutrell2021_so3"
    ...
    translation := "(Thabo) cooked (some/the food)"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def so4 : LinguisticExample :=
  { id := "hahndegenfutrell2021_so4"
    ...
    translation := "(I) was given it (by Thabo)"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def so5 : LinguisticExample :=
  { id := "hahndegenfutrell2021_so5"
    ...
    readings := []
    paperFeatures := [("section", "SI Sesotho"), ("phenomenon", "morphemeOrder")]
    comment := "The verb of Demuth's example; Demuth's glosses carry the noun class of the subject and object markers, dropped here. The supplement's table cites the example as (42)."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def so6 : LinguisticExample :=
  { id := "hahndegenfutrell2021_so6"
    ...
    translation := "(Mpho) was cooked (food)"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("section", "SI Sesotho"), ("phenomenon", "morphemeOrder")]
    comment := "The verb of Demuth's example; Demuth's glosses carry the noun class of the subject and object markers, dropped here. The applicative and the perfect fuse as -ets-; the passive follows them."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def so7 : LinguisticExample :=
  { id := "hahndegenfutrell2021_so7"
    ...
    translation := "(S/he) brings up (the child for her/his daughter)"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("section", "SI Sesotho"), ("phenomenon", "morphemeOrder")]
    comment := "The verb of Demuth's example; Demuth's glosses carry the noun class of the subject and object markers, dropped here. The causative precedes the applicative."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
...
def so8 : LinguisticExample :=
  { id := "hahndegenfutrell2021_so8"
    ...
    translation := "(it is who) that cooked (the food)"
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("section", "SI Sesotho"), ("phenomenon", "morphemeOrder")]
    comment := "The verb of Demuth's example; Demuth's glosses carry the noun class of the subject and object markers, dropped here. The verb of a cleft, with the relative -ng after the mood vowel."
    metaLanguage := "stan1293"
    lgrConformance := "MORPHEME_ALIGNED" }
