...
def ex_4b : LinguisticExample :=
  { id := "asherpelletier2013_4b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Cardinals are bright red."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("problem", "restricted subkind")]
    comment := "Repeated as (32b)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_5 : LinguisticExample :=
  { id := "asherpelletier2013_5"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Mosquitoes carry the West Nile Virus."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("problem", "weak existential")]
    comment := "Repeated as (43b)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_6a : LinguisticExample :=
  { id := "asherpelletier2013_6a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Ravens are normally black."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_6b : LinguisticExample :=
  { id := "asherpelletier2013_6b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "This machine crushes oranges."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("problem", "no actual instances")]
    comment := "Repeated as (13a)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_7 : LinguisticExample :=
  { id := "asherpelletier2013_7"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Penguins don't fly."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_9 : LinguisticExample :=
  { id := "asherpelletier2013_9"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Turtles live to be 100."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := [("teleological", .acceptable), ("statistical", .acceptable)]
    paperFeatures := [("type", "characterizing")]
    comment := "True under the teleological construal of normality, false under the statistical one."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_10 : LinguisticExample :=
  { id := "asherpelletier2013_10"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Girls do better in school than boys."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_13b : LinguisticExample :=
  { id := "asherpelletier2013_13b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Kim handles the mail from Antarctica."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_14a : LinguisticExample :=
  { id := "asherpelletier2013_14a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "People who go to bed late don't get up early."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_14b : LinguisticExample :=
  { id := "asherpelletier2013_14b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Dogs chase cats that chase mice."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_15a : LinguisticExample :=
  { id := "asherpelletier2013_15a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Dinosaurs are extinct."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_15b : LinguisticExample :=
  { id := "asherpelletier2013_15b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Ducks are widespread throughout Europe."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_16 : LinguisticExample :=
  { id := "asherpelletier2013_16"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Ducks lay eggs and are widespread throughout Europe."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "copredication"), ("aspects", "individual, kind")]
    comment := "Repeated as (39a)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_17a : LinguisticExample :=
  { id := "asherpelletier2013_17a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Typhoons arise in this part of the Pacific."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := [("characterizing", .acceptable), ("existential", .acceptable)]
    paperFeatures := [("type", "characterizing")]
    comment := "The existential reading is prominent with prosodic stress on typhoons; the logical forms are (18b) and (19b)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_17b : LinguisticExample :=
  { id := "asherpelletier2013_17b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "There are firemen available."
    context := ""
    judgment := .acceptable
    alternatives := []
...
def ex_20a : LinguisticExample :=
  { id := "asherpelletier2013_20a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "John drinks beer."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("focus", "beer")]
    comment := "Logical form (20b): if John drinks something, it is normally beer."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_20c : LinguisticExample :=
  { id := "asherpelletier2013_20c"
    ...
    comment := "Logical form (20d): if John does something with beer, it is normally drinking it."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_20e : LinguisticExample :=
  { id := "asherpelletier2013_20e"
    ...
    comment := "Logical form (20f): if John has a relevant alternative property, it is normally drinking beer."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_23 : LinguisticExample :=
  { id := "asherpelletier2013_23"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Philosophers rarely smoke nowadays."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_24 : LinguisticExample :=
  { id := "asherpelletier2013_24"
    ...
    discourseSegments := ["Lots of animals make good pets.", "For instance, dogs make good pets."]
    glossedTokens := []
    translation := "Lots of animals make good pets. For instance, dogs make good pets."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_25a : LinguisticExample :=
  { id := "asherpelletier2013_25a"
    ...
    discourseSegments := ["Let's talk about Australian snakes.", "Australian snakes are poisonous."]
    glossedTokens := []
    translation := "Let's talk about Australian snakes. Australian snakes are poisonous."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("focus", "poisonous")]
    comment := "Logical form (26a)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_25b : LinguisticExample :=
  { id := "asherpelletier2013_25b"
    ...
    discourseSegments := ["Let's talk about poisonous snakes.", "Australian snakes are poisonous but South American snakes are not."]
    glossedTokens := []
    translation := "Let's talk about poisonous snakes. Australian snakes are poisonous but South American snakes are not."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("focus", "Australian, South American")]
    comment := "Logical form (26b)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_28 : LinguisticExample :=
  { id := "asherpelletier2013_28"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Australian snakes are poisonous, Asian snakes are too."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("focus", "Australian, Asian"), ("discourse", "parallelism")]
    comment := "Logical form (29)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_30a : LinguisticExample :=
  { id := "asherpelletier2013_30a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Frenchmen eat horsemeat."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("focus", "Frenchmen")]
    comment := "Logical form (30b): a horsemeat eater is normally French."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_31 : LinguisticExample :=
  { id := "asherpelletier2013_31"
    ...
    discourseSegments := ["Let's talk about Frenchmen.", "Frenchmen eat horsemeat, though Belgians do too."]
    glossedTokens := []
    translation := "Let's talk about Frenchmen. Frenchmen eat horsemeat, though Belgians do too."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_33b : LinguisticExample :=
  { id := "asherpelletier2013_33b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Male cardinals are bright red."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_34 : LinguisticExample :=
  { id := "asherpelletier2013_34"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Ducks lay eggs and are female."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_36 : LinguisticExample :=
  { id := "asherpelletier2013_36"
    ...
    discourseSegments := ["These farm animals have different means of reproduction.", "Cows bear live young,", "Ducks lay eggs."]
    glossedTokens := []
    translation := "These farm animals have different means of reproduction. Cows bear live young, Ducks lay eggs."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_38 : LinguisticExample :=
  { id := "asherpelletier2013_38"
    ...
    discourseSegments := ["A: Cardinals are bright red.", "B: Well, male cardinals are bright red; female cardinals are mostly dullish brown."]
    glossedTokens := []
    translation := "A: Cardinals are bright red. B: Well, male cardinals are bright red; female cardinals are mostly dullish brown."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("discourse", "Correction")]
    comment := "B's male and female carry the contrastive-topic contour."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_39b : LinguisticExample :=
  { id := "asherpelletier2013_39b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Mosquitoes are widespread and carry WNV."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_40a : LinguisticExample :=
  { id := "asherpelletier2013_40a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Cardinals are bright red and lay smallish, speckled eggs."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_40b : LinguisticExample :=
  { id := "asherpelletier2013_40b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Lions have large manes and rear their young in groups."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_40c : LinguisticExample :=
  { id := "asherpelletier2013_40c"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Jade is green and black."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_40d : LinguisticExample :=
  { id := "asherpelletier2013_40d"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Jade is green but also sometimes black."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_40e : LinguisticExample :=
  { id := "asherpelletier2013_40e"
    ...
    discourseSegments := ["Jade is green.", "Jade is also black."]
    glossedTokens := []
    translation := "Jade is green. Jade is also black."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_41 : LinguisticExample :=
  { id := "asherpelletier2013_41"
    ...
    discourseSegments := ["You be careful about mosquitoes and deer ticks.", "Mosquitoes carry the WNV and deer ticks do too."]
    glossedTokens := []
    translation := "You be careful about mosquitoes and deer ticks. Mosquitoes carry the WNV and deer ticks do too."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_42a : LinguisticExample :=
  { id := "asherpelletier2013_42a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Asteroids collide with Earth."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_42b : LinguisticExample :=
  { id := "asherpelletier2013_42b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "US governors are bodybuilders."
...
def ex_42c : LinguisticExample :=
  { id := "asherpelletier2013_42c"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Philosophers are athletes."
...
def ex_43a : LinguisticExample :=
  { id := "asherpelletier2013_43a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Nicholas smokes after dinner."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("genericity", "events")]
    comment := "Logical form (44a)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_43c : LinguisticExample :=
  { id := "asherpelletier2013_43c"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Sharks attack an injured bather."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "characterizing"), ("genericity", "individuals, events")]
    comment := "Logical form (44c)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_45 : LinguisticExample :=
  { id := "asherpelletier2013_45"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Australian snakes can be poisonous."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
...
def ex_46a : LinguisticExample :=
  { id := "asherpelletier2013_46a"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Even mammals lay eggs."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := [("existential over kinds", .acceptable)]
    paperFeatures := [("type", "focus-sensitive adverb")]
    comment := "From Sterken 2009; the authors hear an existential quantification over kinds."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_46b : LinguisticExample :=
  { id := "asherpelletier2013_46b"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "Even dogs eat garbage."
    context := ""
    judgment := .acceptable
    alternatives := []
    readings := []
    paperFeatures := [("type", "focus-sensitive adverb"), ("verdict", "false")]
    comment := "From Sterken 2009; false unless discourse restricts the alternatives."
    metaLanguage := "stan1293"
    lgrConformance := "" }
...
def ex_46c : LinguisticExample :=
  { id := "asherpelletier2013_46c"
    ...
    discourseSegments := []
    glossedTokens := []
    translation := "For instance body builders become important politicians."
    context := ""
    ...
    readings := []
    paperFeatures := [("type", "focus-sensitive adverb")]
    comment := "From Sterken 2009; the alternatives are (48a) and (48b)."
    metaLanguage := "stan1293"
    lgrConformance := "" }
