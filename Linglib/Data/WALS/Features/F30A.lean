...
def lookup (code : String) : Option (Datapoint GenderCount) := Datapoint.lookup allData code

/-- Look up a language by ISO 639-3 code. -/
def lookupISO (iso : String) : Option (Datapoint GenderCount) := Datapoint.lookupISO allData iso
