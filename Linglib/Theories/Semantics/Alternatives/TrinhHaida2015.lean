...
namespace Alternatives.TrinhHaida2015

open StructuralAlternatives (PFTree SynCat)
open Alternatives.Symmetry (isSymmetric)
open Exhaustification.Fox2007 (exhB ieIndices nonWeakerIndices)
...
end Alternatives.TrinhHaida2015
