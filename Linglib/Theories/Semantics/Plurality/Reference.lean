...
(@cite{krifka-1989} §1) and widely known to be inadequate for the
modern mass/count picture — @cite{chierchia-1998} argues mass nouns
...
* Bridge to @cite{chierchia-1998} type-shifting / kind-denoting bare
  plurals (`∩P`).
* Bridge to Sutton & Filip overlap-based individuation (substrate
  not yet present).
* Bridge to classifier-language coercion (`Theories/Semantics/Classifier/`).
-/
