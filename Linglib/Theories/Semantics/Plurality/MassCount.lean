...
algebraic-noun account uses (Chierchia 1998 type-shifting,
Champollion 2017 stratified reference, Generics/BarePlurals).
Specific paper replications import this file and instantiate the
predicates on paper-specific data.
...
namespace Semantics.Plurality.MassCount
...
end Semantics.Plurality.MassCount
