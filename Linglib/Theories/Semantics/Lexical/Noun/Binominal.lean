...
section EM
open Semantics.Lexical.Adjective.Intensification (EvaluativeMeasure intensifiedMeaning)
...
section EMBIExample
open Semantics.Lexical.Adjective.Intensification (muHorrible EvaluativeMeasure)
