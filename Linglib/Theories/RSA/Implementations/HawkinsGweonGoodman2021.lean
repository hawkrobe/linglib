...
This is exactly Montague.Modification.intersectiveMod applied iteratively.
...
using `predMod` from Montague.Modification:
...
applying predicate modification (from Montague.Modification) to individual
feature predicates.
-/
