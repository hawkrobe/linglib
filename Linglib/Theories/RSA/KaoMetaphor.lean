...
/-- L0 for "shark" -/
def l0_shark : List (Meaning × ℚ) := UnifiedRSA.L0 metaphorScenario Utterance.shark ()

/-- S1 with dangerous person and QUD "dangerous" -/
def s1_dangerous_goal : List (Utterance × ℚ) :=
  UnifiedRSA.S1 metaphorScenario dangerousPerson () Goal.dangerous

/-- S1 with dangerous person and QUD "category" -/
def s1_category_goal : List (Utterance × ℚ) :=
  UnifiedRSA.S1 metaphorScenario dangerousPerson () Goal.category

/-- S1 with volatile person and QUD "dangerous" -/
def s1_volatile_dangerous : List (Utterance × ℚ) :=
  UnifiedRSA.S1 metaphorScenario volatilePerson () Goal.dangerous

/-- S1 with comforting person and QUD "comforting" -/
def s1_comforting_goal : List (Utterance × ℚ) :=
  UnifiedRSA.S1 metaphorScenario comfortingPerson () Goal.comforting

/-- L1 for "shark" -/
def l1_shark : List (Meaning × ℚ) := UnifiedRSA.L1_world metaphorScenario Utterance.shark

/-- L1 goal distribution for "shark" -/
def l1_goal_shark : List (Goal × ℚ) := UnifiedRSA.L1_qud metaphorScenario Utterance.shark

/-- L1 for "fire" -/
def l1_fire : List (Meaning × ℚ) := UnifiedRSA.L1_world metaphorScenario Utterance.fire

/-- L1 for "blanket" -/
def l1_blanket : List (Meaning × ℚ) := UnifiedRSA.L1_world metaphorScenario Utterance.blanket
...
def l0_shark_strict : List (Meaning × ℚ) := UnifiedRSA.L0 strictScenario Utterance.shark ()
...
def s1_strict_dangerous : List (Utterance × ℚ) :=
  UnifiedRSA.S1 strictScenario dangerousPerson () Goal.dangerous
