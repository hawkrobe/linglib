...
open Montague.Noun.Relational.Barker2011
...
theorem local_pi_matches_barker {E S : Type}
    ...
    Montague.Noun.Relational.Barker2011.π P R z x s := rfl
...
theorem bridging_from_barker {E S : Type}
    ...
    Montague.Noun.Relational.Barker2011.canFillRelatum .appliedPi = true := rfl
...
theorem derivation_chain {E S : Type} :
    ...
    Montague.Noun.Relational.Barker2011.canFillRelatum .appliedPi = true ∧
    -- Step 3-5: Na uses π, so na enables bridging
    Montague.Noun.Relational.Barker2011.canFillRelatum .noRelation = false := ⟨rfl, rfl⟩
...
end Montague.Determiner.Demonstrative.AhnZhu2025
