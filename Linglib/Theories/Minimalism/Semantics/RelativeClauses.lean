...
namespace Minimalism.Semantics.RelativeClauses
...
This module uses:
- `Minimalism.Basic` for syntactic structures with traces
- `Minimalism.Semantics.Interface` for trace interpretation
...
end Minimalism.Semantics.RelativeClauses
