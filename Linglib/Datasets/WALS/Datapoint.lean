...
See `Datasets/WALS/Features/` for the per-feature data files, auto-generated
by `python3 scripts/gen_wals.py`.
-/

namespace Datasets.WALS
...
each entry already references a `walsCode`, and `Datasets.WALS.Languages.findLanguage`
