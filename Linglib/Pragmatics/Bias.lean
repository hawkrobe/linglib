...
[napoli-nespor-1976] [romero-han-2004] [repp-2013]
[farkas-bruce-2010] [hohle-1992]
[romero-2024]
...
[napoli-nespor-1976] first identified the cluster for Italian *non₂*
...
questions ([romero-han-2004], [romero-2024]), VERUM focus
([hohle-1992], [repp-2013]), and discourse rejection moves
([farkas-bruce-2010]). This module provides the framework-neutral
licensing predicate; specific historical and modern implementations
consume it.

## The Four Conditions

[napoli-nespor-1976] §2 establish that bias-conditioned negation is
...
in `Typology.Negation.PolarityLicensing`. The Romero-2024 HiNQ bridge — a
...
[napoli-nespor-1976]'s original implementation routed the licensing
...
is the unit shared with covert-VERUM ([romero-han-2004]) and
commitment-update ([farkas-bruce-2010]) reanalyses.
-/

namespace Pragmatics.Bias

open Typology.Negation (PolarityLicensing weakENProfile)
...
structure BiasLicensingProfile where
  ...
  /-- Speaker's evidence is inferred and the construction does not
      ...
      [napoli-nespor-1976] §2.3 ex. 22, §3.22 ex. 32–34. -/
  imprecise : Bool
...
/-- Bias-conditioned negation is licensed iff all four conditions hold.
    [napoli-nespor-1976] §2: the central licensing claim, formalized
...
/-- Imperative bias context — also blocked because non-assertive.
    [napoli-nespor-1976] §2.1: the assertive condition rules out
...
/-- Each blocking profile blocks bias-marked negation; the four
    distributional facts of [napoli-nespor-1976] §2.1–§2.3
