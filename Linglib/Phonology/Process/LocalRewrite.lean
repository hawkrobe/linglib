...
| Harmonic Serialism | `Phonology/Constraint/OT/HarmonicSerialism.lean` | Iterative constraint-based; named in HS docstring as architecturally-distinct alternative for counterfeeding. |
