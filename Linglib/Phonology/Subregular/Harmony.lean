...
string `System.transduce` is an `OSLRule` (`Core.Computability.Subregular.Function`),
...
open Core.Computability.Subregular.Function (OSLRule IsLeftOutputStrictlyLocal)
