...
* `tierProject T`: keep the symbols satisfying `T`, erase the rest. The `byClass`
  specialization of the keystone `TierProjection.apply` (`Core/Computability/Subregular/Language/TierProjection.lean`).
...
(`Core/Computability/Subregular/Language/TierProjection.lean`), so the autosegmental and subregular
