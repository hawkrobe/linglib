...
A genuine cross-framework bridge: [cooper-2023]'s `InfoState` (§2.6)
is a simplified successor to [ginzburg-2012]'s `TIS`. The
...
The deletions are exactly what [cooper-2023] drops to make TTR
...
the components that [ginzburg-2012] adds beyond [cooper-2023]. -/
