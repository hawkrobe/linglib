...
namespace Phenomena.Indefinites.Studies.DeganoAloni2025.DependenceLogic
...
end Phenomena.Indefinites.Studies.DeganoAloni2025.DependenceLogic

-- ============================================================================
-- §1. The 7-type classification
-- ============================================================================

namespace Phenomena.Indefinites.Studies.DeganoAloni2025
