...
§1. Polarity, cost, and implicature types
§2. Per-construction evaluativity source + derivation
§3. Q-implicature for positive constructions (degree tautology)
§4. R-implicature / Marked Meaning Principle (MMP)
§5. Lexicon-grounded derivation (full pipeline)
§6. Rett's core predictions (theorems)
