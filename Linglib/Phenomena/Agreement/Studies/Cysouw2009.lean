...
theorem allParadigms_count : allParadigms.length = 13 := by decide
...
theorem latin_is_Sa : latin.singularType = .Sa := by decide
theorem dutch_is_Sb : dutchInflection.singularType = .Sb := by decide
theorem spanish_subj_is_Sc : spanishSubjunctive.singularType = .Sc := by decide
theorem english_infl_is_Sd : englishInflection.singularType = .Sd := by decide
theorem french_is_Se : frenchInflection.singularType = .Se := by decide
theorem finnish_is_Sa : finnishInflection.singularType = .Sa := by decide

/-! ### First person complex type verification -/

theorem english_pronouns_Pa : englishPronouns.firstPersonComplexType = .Pa := by decide
theorem english_infl_Pb : englishInflection.firstPersonComplexType = .Pb := by decide
theorem maka_Pc : maka.firstPersonComplexType = .Pc := by decide
theorem mandara_Pd : mandara.firstPersonComplexType = .Pd := by decide
theorem ilocano_Pe : ilocano.firstPersonComplexType = .Pe := by decide
theorem piraha_Pb : piraha.firstPersonComplexType = .Pb := by decide
theorem finnish_Pa : finnishInflection.firstPersonComplexType = .Pa := by decide
...
theorem all_singular_types_attested :
    ...
    allParadigms.any (·.singularType == .Se) = true := by decide
...
theorem all_fpc_types_attested :
    ...
    allParadigms.any (·.firstPersonComplexType == .Pe) = true := by decide
...
theorem homophony_implication_holds :
    allParadigms.all (λ s =>
      if s.hasSingularHomophony then s.isInflectional else true) = true := by decide
...
theorem independent_no_singular_homophony :
    (allParadigms.filter (·.isInflectional == false)).all
      (·.hasSingularHomophony == false) = true := by decide
...
theorem explicitness_correlates_with_forms :
    ...
    englishPronouns.distinctForms > frenchInflection.distinctForms := by decide
...
theorem piraha_maximal_horizontal :
    ...
    piraha.homophonous .s3 .thirdGrp = true := by decide
...
theorem piraha_zero_we_forms : piraha.weFormCount = 0 := by decide
theorem english_one_we_form : englishPronouns.weFormCount = 1 := by decide
theorem maka_one_we_form : maka.weFormCount = 1 := by decide
theorem mandara_two_we_forms : mandara.weFormCount = 2 := by decide
theorem ilocano_three_we_forms : ilocano.weFormCount = 3 := by decide
...
theorem first_person_hierarchy :
    ...
    mandara.weFormCount < ilocano.weFormCount := by decide
...
theorem english_fragment_sa :
    englishPronouns.singularType = .Sa := by decide
...
theorem czech_fragment_sa :
    czechPronouns.singularType = .Sa := by decide

theorem czech_fragment_pa :
    czechPronouns.firstPersonComplexType = .Pa := by decide
...
theorem inflectional_less_explicit :
    (allParadigms.filter (·.isInflectional)).all (λ s =>
      ...
      s.explicitnessLevel == .unifiedWe) = true := by decide
...
theorem independent_more_explicit :
    (allParadigms.filter (·.isInflectional == false)).all (λ s =>
      s.explicitnessLevel != .singularHomophony) = true := by decide
