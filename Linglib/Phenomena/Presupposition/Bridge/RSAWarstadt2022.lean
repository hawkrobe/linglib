...
RSA evaluation infrastructure has been removed. Context types, compatibility
functions, and PrProp connection theorems are preserved. RSA computation
...
/-! ## Green Card: RSA Computation (stubs) -/

-- RSA computation removed; these definitions are stubs for future reimplementation.
