...
namespace Phenomena.Conditionals.Studies.CarianiGoldstein2020

open Core.Duality (Truth3)
open Core.Order (SimilarityOrdering)
open Phenomena.Conditionals.Studies.Santorio2018 (DecAlt homogeneityEval)
...
end Phenomena.Conditionals.Studies.CarianiGoldstein2020
