...
- **Architecturally**, no rule is invoked. The neutralisation falls out
  ...
  lemma `Phenomena.Tone.Studies.ChuangEtAl2026.dlm_neutralizes_meanings_in_kernel`.
...
namespace Phenomena.Tone.Studies.LuChuangBaayen2026

open Theories.Processing.Lexical.Discriminative
open Phenomena.Tone.Studies.ChuangEtAl2026
...
/-- **T3 tone sandhi neutralization via DLM kernel**.
    ...
    `Phenomena.Tone.Studies.ChuangEtAl2026.dlm_neutralizes_meanings_in_kernel`. -/
...
end Phenomena.Tone.Studies.LuChuangBaayen2026
