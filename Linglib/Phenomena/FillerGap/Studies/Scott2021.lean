...
theorem features_1sg :
    ...
    [.valued (.phi (.number .Sing)),
     .valued (.phi (.gender 1)),
     .valued (.phi (.person .first))] := by native_decide
...
theorem features_after_deletion :
    ...
    [.valued (.phi (.number .Sing)),
     .valued (.phi (.gender 1))] := by native_decide
...
theorem maxElide_targets_persP : maxElideTarget = some .Pers := by native_decide
...
theorem reduction_preserves_number :
    ...
    isSg (extractFeatures pronTree1sg) := by native_decide
...
theorem reduction_preserves_animacy :
    ...
    isAnim (extractFeatures pronTree1sg) := by native_decide
...
theorem bound_retains_person :
    hasPerson (extractFeatures pronTree1sg) = true := by native_decide
