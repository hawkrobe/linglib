...
- A `commentative`-emitting fix to `deriveCTPClass` in
  `Phenomena/Complementation/Studies/Noonan2007.lean:570`: blocked on
...
namespace Phenomena.Complementation.Studies.Deal2026
...
-- `Phenomena/Complementation/Studies/Angelopoulos2026.lean`
...
`Phenomena/Complementation/Studies/Cacchioli2025.lean` independently
...
end Phenomena.Complementation.Studies.Deal2026
