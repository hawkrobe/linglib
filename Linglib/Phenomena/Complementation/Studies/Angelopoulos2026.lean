...
- `hkIncorporable` predicate: @cite{hale-keyser-1993} noun-
  ...
  `ArgumentRealization` noun-incorporation (Beavers-Udayana 2022
...
namespace Phenomena.Complementation.Studies.Angelopoulos2026
...
end Phenomena.Complementation.Studies.Angelopoulos2026
