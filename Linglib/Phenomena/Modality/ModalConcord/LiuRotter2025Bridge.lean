...
theorem both_studies_single_necessity :
    (Phenomena.Modality.ModalConcord.meaningRating .must).mean -
    (Phenomena.Modality.ModalConcord.meaningRating .mustHaveTo).mean < 1/2 ∧
...
theorem complementary_diagnostics :
    (Phenomena.Modality.ModalConcord.formalityRating .haveTo).mean <
    (Phenomena.Modality.ModalConcord.formalityRating .mustHaveTo).mean ∧
