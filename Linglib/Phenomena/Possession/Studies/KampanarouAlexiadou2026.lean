...
namespace Phenomena.Possession.Studies.KampanarouAlexiadou2026
...
theorem ka2026_refutes_myler_VI_for_smg :
    ...
    Fragments.Greek.StandardModern.Possession.possession.adnominalStrategy
      = .dependentMarking := by
  refine ⟨rfl, rfl⟩
...
theorem gg_uses_reduced_relative_smg_does_not :
    ...
    Fragments.Greek.Grevena.Possession.possession.adnominalStrategy
      = .juxtaposition ∧
...
end Phenomena.Possession.Studies.KampanarouAlexiadou2026
