...
, Section 5.1-5.3: Both yield non-exhaustive answers, but differ
...
, Section 5.2: Negative answers satisfy P-ANS but are NOT acceptable
...
, Section 5.4: Verbs like "depends" and "matter" BLOCK mention-some
...
, Section 5.3 (citing Belnap): Questions like "Where do two unicorns live?"
...
, Section 5.4: The questioner's practical goal makes partial
