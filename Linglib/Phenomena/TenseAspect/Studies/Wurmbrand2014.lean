...
def ex1a : LinguisticExample :=
  { id := "wurmbrand2014_ex1a"
    ...
    paperFeatures := []
    comment := "Wurmbrand 2014 ex (1a), LI 45(3) p. 403–404. First diagnostic in her classification of infinitival tense. The HK1998Data §15 `wantedToLeave` (\"John wanted to leave\") is the same class (future irrealis with `want`)."
