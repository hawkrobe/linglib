...
The 4 dimensions project onto existing `Verb.Root.Profile` features:
...
`Verb.Root.Profile` defines **regions** over. A verb is compatible with an
...
-- ════════════════════════════════════════════════════
-- § 4. Compatibility with Verb.Root.Profile
-- ════════════════════════════════════════════════════
...
def SeparationEvent.compatibleWith (e : SeparationEvent) (r : Verb.Root.Profile) : Bool :=
...
private def fragmentProfile (v : VerbEntry) : Verb.Root.Profile :=
  v.rootProfile.getD {}
