...
([percus-2006], [sauerland-2008]) and obligatory-implicature
accounts ([magri-2009]) is real. This file commits to MP.
-/
...
[sauerland-2003] formalizes MP competition over phi-features
(sg/pl/dual) via direct alternatives — the standard
[percus-2006], [sauerland-2008] mechanism. That account
correctly predicts:
