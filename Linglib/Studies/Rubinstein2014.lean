...
private def fragmentMarksWeak : String → Bool
  | "should"  => English.Auxiliaries.should.modality.any (·.force == .weakNecessity)
  | "ought"   => English.Auxiliaries.ought.modality.any (·.force == .weakNecessity)
  | "must"    => English.Auxiliaries.must.modality.any (·.force == .weakNecessity)
  | "have to" => English.Auxiliaries.haveTo.modality.any (·.force == .weakNecessity)
  | "need"    => English.Auxiliaries.need.modality.any (·.force == .weakNecessity)
  | _         => false
...
theorem fragment_need_strong :
    English.Auxiliaries.need.modality.any
      (·.force == .necessity) = true := by decide
