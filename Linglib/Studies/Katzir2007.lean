...
alternative is strictly stronger and weakly assertable, the substrate's `Competition.Blocked`
...
open Syntax Alternatives Alternatives.Structural Competition
