...
decomposition from `Semantics.Quantification.PolarizedIndividuals`, then derives
...
`Semantics.Quantification.PolarizedIndividuals`.
...
/-- The split scope reading: `(e,+) ⊔ (e,-) = λR S. R(e)`.
    Re-exported from `Semantics.Quantification.PolarizedIndividuals`. The lattice-theoretic
