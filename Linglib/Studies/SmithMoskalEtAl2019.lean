...
open Morphology Morphology.Paradigm Morphology.Containment
...
theorem lezgian_aaa : syncretism lezgian1sg = syncretism aaa := by decide

theorem icelandic_abb : syncretism icelandic1sg = syncretism abb := by decide

theorem russian_abb : syncretism russian1sg = syncretism abb := by decide

/-- The attested ABB of the number hierarchy: Awtuw's plural and dual share a base. -/
theorem awtuw_abb : syncretism awtuw1 = syncretism abb := by decide
...
theorem icelandic_abb_generated : syncretism (realize icelandicVocab) = syncretism abb := by decide
...
theorem wardaman_aab : syncretism wardaman3sg = syncretism aab := by decide

theorem khinalugh_aab : syncretism khinalugh2sg = syncretism aab := by decide
...
theorem yagua_aab : syncretism yagua2 = syncretism aab := by decide

theorem wambaya_aab : syncretism wambaya1incl = syncretism aab := by decide

theorem dehu_aab : syncretism dehu3m = syncretism aab := by decide
...
theorem wardaman_aab_generated :
    Antihomophonous wardamanVocab ∧ DomainLocal 2 wardamanVocab ∧
      syncretism (realize wardamanVocab) = syncretism aab := by
  refine ⟨?_, ?_, ?_⟩ <;> decide
