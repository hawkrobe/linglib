...
/-- §4 observation: among the attested items, every determiner is exception-intolerant. -/
...
/-- The rows of (1), (2), (4) and (22a) classify the items as (5) does, *jeweils* out
