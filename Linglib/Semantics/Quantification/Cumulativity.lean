...
| Beck-Sauerland `**` | Pluralization operator on relations between Finsets | `Semantics/Plurality/Cumulativity.lean` |
| Champollion `*` | Cumulative-closure on event predicates | `Semantics/Events/Aspect/Cumulativity.lean` |
