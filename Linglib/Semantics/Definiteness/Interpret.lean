...
theorem interpret_demonstrative
    (R : Restrictor E W) (deictic : Reference.Deixis)
...
theorem interpret_unique_index_irrelevant
    (R : Restrictor E W) (sIdx₁ sIdx₂ : Nat)
    (g : Assignment E) (gs : SitAssignment W) :
