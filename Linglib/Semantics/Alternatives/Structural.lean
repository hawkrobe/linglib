...
an alternative source for the competition relation of `Pragmatics/Competition.lean`.
...
/-- The structural alternatives as an alternative source for `Competition.Blocked`. -/
