...
an alternative source for the competition relation of `NeoGricean.Competition`.
...
/-- The structural alternatives as an alternative source for `NeoGricean.Blocked`. -/
