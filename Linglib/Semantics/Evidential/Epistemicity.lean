...
domain. Linglib already covers evidential source (`Semantics/Evidential/Defs.lean`),
epistemic modality (`Modality/Kernel.lean`), and mirativity (`Semantics/Evidential/Mirativity.lean`),
