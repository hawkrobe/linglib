...
[fox-2007] [chierchia-2013] [alonso-ovalle-moghiseh-2025a]
...
* `tolerant_exh_eq_empty_iff` — `tolerant.exh ALT φ = ∅` iff every
  ...
  exhaustification" used in [alonso-ovalle-moghiseh-2025a]'s
...
* `innocent_exh_pairwise_disjoint_partial` — when `(φ \ ALT.sup id)`
  ...
  Drives [alonso-ovalle-moghiseh-2025a]'s root domain-only
...
* `innocent_exh_singleton_proper` — corollary of the above for
  ...
  ([alonso-ovalle-moghiseh-2025a] eq. 93a).
...
* `innocent_exh_pairwise_disjoint_cover` — when ALT's members are
  ...
  driving [alonso-ovalle-moghiseh-2025a] eq. 101's missing third
...
contradiction" case driving [alonso-ovalle-moghiseh-2025a] eq. 92. -/
...
exhaustification result ([alonso-ovalle-moghiseh-2025a] eq. 93a):
