...
theorem fin4_case_13 (sys : EpistemicSystemFA (Fin 4))
  ...
  -- pair vs pair (ge_pair_via_mid / nge_pair_via_contra)
  ...
  have hd27 := ge_pair_via_mid sys ({0,3} : Set _) ({1,2} : Set _) ({0,1} : Set _)
    h31 h02 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd28 := nge_pair_via_contra sys ({2,3} : Set _) ({0,1} : Set _) ({0,2} : Set _)
    h12 hng30 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd29 := nge_pair_via_contra sys ({1,3} : Set _) ({0,2} : Set _) ({0,1} : Set _)
    h21 hng30 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd30 := nge_pair_via_contra sys ({1,2} : Set _) ({0,3} : Set _) ({0,1} : Set _)
    h31 hng20 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
    ...
    · -- h123_0=T (1 pat)
      exact fin4_witness sys (1/2) (1/6) (1/6) (by linarith) (by linarith) (by linarith) (by linarith)
        ...
        (fin4_dispatch sys (1/2) (1/6) (1/6) (by linarith) (by linarith) (by linarith) (by linarith)
          ...
          (bp h13 (by linarith)) (bp h31 (by linarith))
          (bp h23 (by linarith)) (bp h32 (by linarith))
          -- singleton vs pair (24)
          (bp hd34 (by linarith)) (bp hd35 (by linarith)) (bp hd36 (by linarith))
          ...
          (bn hd22 (fun h => by linarith)) (bn hd23 (fun h => by linarith))
          (bn hd24 (fun h => by linarith))
          ...
          (bp hd26 (by linarith)) (bn hd29 (fun h => by linarith))
          (bp hd27 (by linarith)) (bn hd30 (fun h => by linarith)))
    · -- h123_0=F (1 pat)
      ...
      · -- h12_0=T (1 pat)
        ...
        exact fin4_witness sys (2/5) (1/5) (1/5) (by linarith) (by linarith) (by linarith) (by linarith)
          ...
          (fin4_dispatch sys (2/5) (1/5) (1/5) (by linarith) (by linarith) (by linarith) (by linarith)
            ...
            (bp h23 (by linarith)) (bp h32 (by linarith))
            -- singleton vs pair (24)
            (bp h0_12_hyp (by linarith)) (bp hd38 (by linarith)) (bp hd39 (by linarith))
            (bn hd13 (fun h => by linarith)) (bn hd14 (fun h => by linarith))
            (bn hd15 (fun h => by linarith)) (bn hd16 (fun h => by linarith))
            (bn hd17 (fun h => by linarith)) (bn hd18 (fun h => by linarith))
            (bn hd19 (fun h => by linarith)) (bn hd20 (fun h => by linarith))
            (bn hd21 (fun h => by linarith))
            (bp h12_0_hyp (by linarith)) (bp hd40 (by linarith)) (bp hd41 (by linarith))
            -- pair ← singleton (12)
            (bp hd1 (by linarith)) (bp hd2 (by linarith)) (bp hd3 (by linarith))
            (bp hd4 (by linarith)) (bp hd5 (by linarith)) (bp hd6 (by linarith))
            (bp hd7 (by linarith)) (bp hd8 (by linarith)) (bp hd9 (by linarith))
      ...
      · -- h12_0=F (1 pat)
        ...
        exact fin4_witness sys (3/7) (4/21) (4/21) (by linarith) (by linarith) (by linarith) (by linarith)
          ...
          (fin4_dispatch sys (3/7) (4/21) (4/21) (by linarith) (by linarith) (by linarith) (by linarith)
            ...
            (bn hd19 (fun h => by linarith)) (bn hd20 (fun h => by linarith))
            (bn hd21 (fun h => by linarith))
            (bn h12_0_hyp (fun h => by linarith))
            (bn hd42 (fun h => by linarith)) (bn hd43 (fun h => by linarith))
            -- pair ← singleton (12)
            (bp hd1 (by linarith)) (bp hd2 (by linarith)) (bp hd3 (by linarith))
            (bp hd4 (by linarith)) (bp hd5 (by linarith)) (bp hd6 (by linarith))
            (bp hd7 (by linarith)) (bp hd8 (by linarith)) (bp hd9 (by linarith))
    ...
    · -- h0_12=F (1 pat)
      ...
      exact fin4_witness sys (2/7) (5/21) (5/21) (by linarith) (by linarith) (by linarith) (by linarith)
        ...
        (fin4_dispatch sys (2/7) (5/21) (5/21) (by linarith) (by linarith) (by linarith) (by linarith)
          ...
          (bp h23 (by linarith)) (bp h32 (by linarith))
          -- singleton vs pair (24)
          (bn h0_12_hyp (fun h => by linarith))
          (bn hd44 (fun h => by linarith)) (bn hd45 (fun h => by linarith))
          (bn hd13 (fun h => by linarith)) (bn hd14 (fun h => by linarith))
          (bn hd15 (fun h => by linarith)) (bn hd16 (fun h => by linarith))
          (bn hd17 (fun h => by linarith)) (bn hd18 (fun h => by linarith))
          (bn hd19 (fun h => by linarith)) (bn hd20 (fun h => by linarith))
          (bn hd21 (fun h => by linarith))
          (bp hd46 (by linarith)) (bp hd47 (by linarith)) (bp hd48 (by linarith))
          -- pair ← singleton (12)
          (bp hd1 (by linarith)) (bp hd2 (by linarith)) (bp hd3 (by linarith))
          (bp hd4 (by linarith)) (bp hd5 (by linarith)) (bp hd6 (by linarith))
          (bp hd7 (by linarith)) (bp hd8 (by linarith)) (bp hd9 (by linarith))
