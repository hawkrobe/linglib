...
theorem fin4_case_22 (sys : EpistemicSystemFA (Fin 4))
  ...
  have hd31 := ge_pair_via_mid sys ({1,3} : Set _) ({0,2} : Set _) ({0,3} : Set _)
    h10 h32 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd32 := ge_pair_via_mid sys ({0,3} : Set _) ({1,2} : Set _) ({0,2} : Set _)
    h32 h01 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd33 := ge_pair_via_mid sys ({1,2} : Set _) ({0,3} : Set _) ({0,2} : Set _)
    h10 h23 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd34 := nge_pair_via_contra sys ({2,3} : Set _) ({0,1} : Set _) ({0,2} : Set _)
    ...
    · -- h23_0=T (1 pat)
      ...
      exact fin4_witness sys (1/3) (1/3) (1/6) (by linarith) (by linarith) (by linarith) (by linarith)
        ...
        (fin4_dispatch sys (1/3) (1/3) (1/6) (by linarith) (by linarith) (by linarith) (by linarith)
          ...
          (bp hd29 (by linarith)) (bn hd34 (fun h => by linarith))
          (bp hd30 (by linarith)) (bp hd31 (by linarith))
          (bp hd32 (by linarith)) (bp hd33 (by linarith)))
    · -- h23_0=F (1 pat)
