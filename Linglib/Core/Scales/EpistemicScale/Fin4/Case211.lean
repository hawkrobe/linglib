...
/-- Case (2,1,1): 3 sub-cases. -/
theorem fin4_case_211 (sys : EpistemicSystemFA (Fin 4))
  ...
  have hd15 := nge_singleton_pair sys h10 hn2 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd16 := nge_singleton_pair sys h10 hn3 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd17 := nge_singleton_pair sys h01 hn2 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd18 := nge_singleton_pair sys h01 hn3 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd19 := nge_singleton_pair sys h02 hn1 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd20 := nge_singleton_pair sys h02 hn3 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd21 := nge_singleton_pair sys h12 hn3 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd22 := nge_singleton_pair sys h03 hn1 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd23 := nge_singleton_pair sys h03 hn2 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd24 := nge_singleton_pair sys h13 hn2 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  ...
  have hd29 := ge_pair_via_mid sys ({0,1} : Set _) ({2,3} : Set _) ({0,2} : Set _)
    h12 h03 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd30 := ge_pair_via_mid sys ({0,2} : Set _) ({1,3} : Set _) ({0,3} : Set _)
    h23 h01 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd31 := ge_pair_via_mid sys ({1,2} : Set _) ({0,3} : Set _) ({0,2} : Set _)
    h10 h23 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd32 := nge_pair_via_contra sys ({2,3} : Set _) ({0,1} : Set _) ({0,2} : Set _)
    h12 hng30 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd33 := nge_pair_via_contra sys ({1,3} : Set _) ({0,2} : Set _) ({1,2} : Set _)
    h01 hng32 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  have hd34 := nge_pair_via_contra sys ({0,3} : Set _) ({1,2} : Set _) ({0,2} : Set _)
    h10 hng32 (by sdiff) (by sdiff) (by sdiff) (by sdiff)
  ...
  · -- h0_23=T (2 pat)
    ...
    · -- h23_0=T (1 pat)
      ...
      exact fin4_witness sys (1/3) (1/3) (4/21) (by linarith) (by linarith) (by linarith) (by linarith)
        hn0 hn1 hn2 hn3
        (fin4_dispatch sys (1/3) (1/3) (4/21) (by linarith) (by linarith) (by linarith) (by linarith)
          hn0 hn1 hn2 hn3
          ...
          (bp h01 (by linarith)) (bp h10 (by linarith))
          ...
          (bp hd36 (by linarith))
          (bp hd5 (by linarith)) (bp hd6 (by linarith))
          (bp hd7 (by linarith))
          (bp hd8 (by linarith)) (bp hd9 (by linarith))
          (bp hd10 (by linarith))
          ...
          (bp hd29 (by linarith)) (bn hd32 (fun h => by linarith))
          (bp hd30 (by linarith)) (bn hd33 (fun h => by linarith))
          (bn hd34 (fun h => by linarith)) (bp hd31 (by linarith)))
    · -- h23_0=F (1 pat)
      have hd37 : ¬sys.ge ({2,3} : Set (Fin 4)) ({(1 : Fin 4)} : Set _) :=
        fun h => h23_0_hyp (sys.trans _ _ _ h h10)
      exact fin4_witness sys (5/14) (5/14) (1/6) (by linarith) (by linarith) (by linarith) (by linarith)
        hn0 hn1 hn2 hn3
        (fin4_dispatch sys (5/14) (5/14) (1/6) (by linarith) (by linarith) (by linarith) (by linarith)
          hn0 hn1 hn2 hn3
          (mf4_empty ..) (mf4_s0 ..) (mf4_s1 ..) (mf4_s2 ..) (mf4_s3 ..)
          (mf4_p01 ..) (mf4_p02 ..) (mf4_p03 ..) (mf4_p12 ..) (mf4_p13 ..) (mf4_p23 ..)
          (mf4_t012 ..) (mf4_t013 ..) (mf4_t023 ..) (mf4_t123 ..)
  ...
  · -- h0_23=F (1 pat)
    ...
    exact fin4_witness sys (2/7) (2/7) (5/21) (by linarith) (by linarith) (by linarith) (by linarith)
      hn0 hn1 hn2 hn3
      (fin4_dispatch sys (2/7) (2/7) (5/21) (by linarith) (by linarith) (by linarith) (by linarith)
        hn0 hn1 hn2 hn3
        (mf4_empty ..) (mf4_s0 ..) (mf4_s1 ..) (mf4_s2 ..) (mf4_s3 ..)
        (mf4_p01 ..) (mf4_p02 ..) (mf4_p03 ..) (mf4_p12 ..) (mf4_p13 ..) (mf4_p23 ..)
        (mf4_t012 ..) (mf4_t013 ..) (mf4_t023 ..) (mf4_t123 ..)
