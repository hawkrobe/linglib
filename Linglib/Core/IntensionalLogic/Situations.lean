...
`Theories/Semantics/Conditionals/Kratzer/Lumping.lean` (forthcoming);
those are theory-laden and depend on a chosen modal base. This file
keeps only the order-theoretic core.
-/
