...
inductive SuppletionInImperativesAndHortatives where
  | aRegularAndASuppletiveFormAlternate  -- A regular and a suppletive form alternate (8 languages)
  | imperative  -- Imperative (29 languages)
...
/-- A single WALS 79B datapoint. -/
structure Datapoint where
  walsCode : String
  language : String
  iso : String
  value : SuppletionInImperativesAndHortatives
  deriving Repr, BEq, DecidableEq

/-- Complete WALS 79B dataset (193 languages). -/
def allData : List Datapoint :=
  [ { walsCode := "xun", language := "!Xun (Ekoka)", iso := "knw", value := .imperative }
  , { walsCode := "abk", language := "Abkhaz", iso := "abk", value := .none }
  , { walsCode := "aco", language := "Acoma", iso := "kjq", value := .hortative }
  , { walsCode := "ain", language := "Ainu", iso := "ain", value := .none }
  , { walsCode := "agw", language := "Alagwa", iso := "wbj", value := .imperativeAndHortative }
  ...
  , { walsCode := "aeg", language := "Arabic (Egyptian)", iso := "arz", value := .imperative }
  , { walsCode := "amr", language := "Arabic (Moroccan)", iso := "ary", value := .imperative }
  , { walsCode := "atu", language := "Arabic (Tunisian)", iso := "aeb", value := .imperative }
  , { walsCode := "ana", language := "Araona", iso := "aro", value := .none }
  , { walsCode := "arp", language := "Arapesh (Mountain)", iso := "ape", value := .none }
  , { walsCode := "arm", language := "Armenian (Eastern)", iso := "hye", value := .imperative }
  ...
  , { walsCode := "bma", language := "Berber (Middle Atlas)", iso := "tzm", value := .aRegularAndASuppletiveFormAlternate }
  , { walsCode := "brh", language := "Brahui", iso := "brh", value := .none }
  , { walsCode := "bul", language := "Bulgarian", iso := "bul", value := .aRegularAndASuppletiveFormAlternate }
  ...
  , { walsCode := "car", language := "Carib", iso := "car", value := .imperative }
  ...
  , { walsCode := "fin", language := "Finnish", iso := "fin", value := .imperative }
  ...
  , { walsCode := "geo", language := "Georgian", iso := "kat", value := .imperative }
  ...
  , { walsCode := "grk", language := "Greek (Modern)", iso := "ell", value := .imperative }
  , { walsCode := "grw", language := "Greenlandic (West)", iso := "kal", value := .none }
  , { walsCode := "gua", language := "Guaraní", iso := "gug", value := .aRegularAndASuppletiveFormAlternate }
  ...
  , { walsCode := "hop", language := "Hopi", iso := "hop", value := .imperative }
  , { walsCode := "hun", language := "Hungarian", iso := "hun", value := .aRegularAndASuppletiveFormAlternate }
  ...
  , { walsCode := "ing", language := "Ingush", iso := "inh", value := .imperative }
  , { walsCode := "irq", language := "Iraqw", iso := "irk", value := .aRegularAndASuppletiveFormAlternate }
  , { walsCode := "iri", language := "Irish", iso := "gle", value := .imperative }
  , { walsCode := "jak", language := "Jakaltek", iso := "jac", value := .imperative }
  , { walsCode := "jpn", language := "Japanese", iso := "jpn", value := .none }
  , { walsCode := "knd", language := "Kannada", iso := "kan", value := .none }
  , { walsCode := "knr", language := "Kanuri", iso := "knc", value := .imperative }
  ...
  , { walsCode := "kse", language := "Koyraboro Senni", iso := "ses", value := .imperative }
  , { walsCode := "kro", language := "Krongo", iso := "kgo", value := .hortative }
  , { walsCode := "knm", language := "Kunama", iso := "kun", value := .imperative }
  ...
  , { walsCode := "lez", language := "Lezgian", iso := "lez", value := .imperative }
  , { walsCode := "luv", language := "Luvale", iso := "lue", value := .imperative }
  , { walsCode := "mcd", language := "Macedonian", iso := "mkd", value := .aRegularAndASuppletiveFormAlternate }
  ...
  , { walsCode := "mlt", language := "Maltese", iso := "mlt", value := .imperative }
  ...
  , { walsCode := "mxc", language := "Mixtec (Chalcatongo)", iso := "mig", value := .imperative }
  ...
  , { walsCode := "mrl", language := "Murle", iso := "mur", value := .imperative }
  , { walsCode := "nht", language := "Nahuatl (Tetelcingo)", iso := "nhg", value := .aRegularAndASuppletiveFormAlternate }
  ...
  , { walsCode := "ntu", language := "Nenets", iso := "yrk", value := .imperative }
  ...
  , { walsCode := "orb", language := "Oromo (Boraana)", iso := "gax", value := .imperative }
  , { walsCode := "orh", language := "Oromo (Harar)", iso := "hae", value := .imperative }
  ...
  , { walsCode := "ram", language := "Rama", iso := "rma", value := .imperative }
  , { walsCode := "rap", language := "Rapanui", iso := "rap", value := .none }
  , { walsCode := "rus", language := "Russian", iso := "rus", value := .imperative }
  ...
  , { walsCode := "scr", language := "Serbian-Croatian", iso := "hbs", value := .aRegularAndASuppletiveFormAlternate }
  ...
  , { walsCode := "spa", language := "Spanish", iso := "spa", value := .imperative }
  ...
  , { walsCode := "swa", language := "Swahili", iso := "swh", value := .imperative }
  ...
  , { walsCode := "wch", language := "Wichí", iso := "mzh", value := .imperative }
...
theorem count_aRegularAndASuppletiveFormAlternate :
    (allData.filter (·.value == .aRegularAndASuppletiveFormAlternate)).length = 8 := by native_decide
theorem count_imperative :
    (allData.filter (·.value == .imperative)).length = 29 := by native_decide
theorem count_hortative :
    (allData.filter (·.value == .hortative)).length = 2 := by native_decide
theorem count_imperativeAndHortative :
    (allData.filter (·.value == .imperativeAndHortative)).length = 1 := by native_decide
theorem count_none :
    (allData.filter (·.value == .none)).length = 153 := by native_decide
