...
namespace Core.WALS.F6A

/-- WALS 6A values. -/
inductive UvularConsonants where
  | none  -- None (470 languages)
...
/-- A single WALS 6A datapoint. -/
structure Datapoint where
  walsCode : String
  language : String
  iso : String
  value : UvularConsonants
  deriving Repr, BEq, DecidableEq

private def allData_0 : List Datapoint :=
  [ { walsCode := "xoo", language := "!Xóõ", iso := "nmn", value := .uvularStopsOnly }
  , { walsCode := "ani", language := "//Ani", iso := "hnh", value := .uvularStopsOnly }
  , { walsCode := "abi", language := "Abipón", iso := "axb", value := .uvularStopsAndContinuants }
  , { walsCode := "abk", language := "Abkhaz", iso := "abk", value := .uvularStopsOnly }
  , { walsCode := "acm", language := "Achumawi", iso := "acv", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "aht", language := "Ahtna", iso := "aht", value := .uvularStopsAndContinuants }
  , { walsCode := "aik", language := "Aikaná", iso := "tba", value := .none }
  , { walsCode := "ain", language := "Ainu", iso := "ain", value := .none }
  , { walsCode := "aiz", language := "Aizi", iso := "ahp", value := .none }
  ...
  , { walsCode := "aea", language := "Aleut (Eastern)", iso := "ale", value := .uvularStopsAndContinuants }
  , { walsCode := "ald", language := "Alladian", iso := "ald", value := .none }
  ...
  , { walsCode := "aeg", language := "Arabic (Egyptian)", iso := "arz", value := .uvularStopsAndContinuants }
  , { walsCode := "ana", language := "Araona", iso := "aro", value := .none }
  , { walsCode := "arp", language := "Arapesh (Mountain)", iso := "ape", value := .none }
  , { walsCode := "arc", language := "Archi", iso := "aqc", value := .uvularStopsAndContinuants }
  , { walsCode := "arm", language := "Armenian (Eastern)", iso := "hye", value := .uvularContinuantsOnly }
  , { walsCode := "amp", language := "Arrernte (Mparntwe)", iso := "aer", value := .none }
  , { walsCode := "asm", language := "Asmat", iso := "cns", value := .none }
  , { walsCode := "ata", language := "Atayal", iso := "tay", value := .uvularStopsOnly }
  , { walsCode := "ava", language := "Avar", iso := "ava", value := .uvularStopsAndContinuants }
  , { walsCode := "awp", language := "Awa Pit", iso := "kwi", value := .none }
  , { walsCode := "awn", language := "Awngi", iso := "awn", value := .uvularStopsOnly }
  , { walsCode := "aym", language := "Aymara (Central)", iso := "ayr", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "brb", language := "Bariba", iso := "bba", value := .none }
  , { walsCode := "bsk", language := "Bashkir", iso := "bak", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "bco", language := "Bella Coola", iso := "blc", value := .uvularStopsAndContinuants }
  , { walsCode := "ben", language := "Bengali", iso := "ben", value := .none }
  , { walsCode := "bma", language := "Berber (Middle Atlas)", iso := "tzm", value := .uvularStopsOnly }
  ...
  , { walsCode := "bur", language := "Burushaski", iso := "bsk", value := .uvularStopsAndContinuants }
  , { walsCode := "bet", language := "Bété", iso := "bev", value := .none }
  , { walsCode := "cac", language := "Cacua", iso := "cbv", value := .none }
  , { walsCode := "cad", language := "Caddo", iso := "cad", value := .none }
  , { walsCode := "cah", language := "Cahuilla", iso := "chl", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "chl", language := "Chehalis (Upper)", iso := "cjh", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "chk", language := "Chukchi", iso := "ckt", value := .uvularStopsOnly }
  ...
  , { walsCode := "coo", language := "Coos (Hanis)", iso := "csz", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "dah", language := "Dahalo", iso := "dal", value := .none }
  , { walsCode := "ddf", language := "Daju (Dar Fur)", iso := "daj", value := .uvularContinuantsOnly }
  ...
  , { walsCode := "det", language := "Deti", iso := "shg", value := .none }
  , { walsCode := "die", language := "Diegueño (Mesa Grande)", iso := "dih", value := .uvularStopsOnly }
  ...
  , { walsCode := "don", language := "Dong (Southern)", iso := "kmc", value := .uvularContinuantsOnly }
  , { walsCode := "doy", language := "Doyayo", iso := "dow", value := .none }
  ...
  , { walsCode := "eja", language := "Ejagham", iso := "etu", value := .none }
  ...
  , { walsCode := "ewo", language := "Ewondo", iso := "ewo", value := .none }
  , { walsCode := "eya", language := "Eyak", iso := "eya", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "fre", language := "French", iso := "fra", value := .uvularContinuantsOnly }
  ...
  , { walsCode := "gla", language := "Gelao", iso := "gqu", value := .uvularStopsOnly }
  , { walsCode := "geo", language := "Georgian", iso := "kat", value := .uvularStopsAndContinuants }
  , { walsCode := "ger", language := "German", iso := "deu", value := .uvularContinuantsOnly }
  ...
  , { walsCode := "grw", language := "Greenlandic (West)", iso := "kal", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "had", language := "Hadza", iso := "hts", value := .none }
  , { walsCode := "hai", language := "Haida", iso := "hai", value := .uvularStopsAndContinuants }
  , { walsCode := "hak", language := "Hakka", iso := "hak", value := .none }
  , { walsCode := "hmr", language := "Hamer", iso := "amf", value := .uvularStopsOnly }
  , { walsCode := "ham", language := "Hamtai", iso := "hmt", value := .uvularStopsOnly }
  , { walsCode := "hau", language := "Hausa", iso := "hau", value := .none }
  , { walsCode := "haw", language := "Hawaiian", iso := "haw", value := .none }
  , { walsCode := "hba", language := "Hebrew (Modern Ashkenazic)", iso := "heb", value := .uvularContinuantsOnly }
  , { walsCode := "hin", language := "Hindi", iso := "hin", value := .none }
  , { walsCode := "hix", language := "Hixkaryana", iso := "hix", value := .none }
  , { walsCode := "hmo", language := "Hmong Njua", iso := "hnj", value := .uvularStopsOnly }
  , { walsCode := "hop", language := "Hopi", iso := "hop", value := .uvularStopsOnly }
  ...
  , { walsCode := "hzb", language := "Hunzib", iso := "huz", value := .uvularStopsAndContinuants }
  , { walsCode := "hup", language := "Hupa", iso := "hup", value := .uvularStopsOnly }
  ...
  , { walsCode := "ing", language := "Ingush", iso := "inh", value := .uvularStopsAndContinuants }
  , { walsCode := "irx", language := "Iranxe", iso := "irn", value := .none }
  , { walsCode := "irq", language := "Iraqw", iso := "irk", value := .uvularStopsOnly }
  , { walsCode := "irr", language := "Irarutu", iso := "irh", value := .none }
  , { walsCode := "ird", language := "Irish (Donegal)", iso := "gle", value := .none }
  , { walsCode := "iso", language := "Isoko", iso := "iso", value := .none }
  , { walsCode := "ite", language := "Itelmen", iso := "itl", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "jak", language := "Jakaltek", iso := "jac", value := .uvularStopsAndContinuants }
  , { walsCode := "jpn", language := "Japanese", iso := "jpn", value := .uvularContinuantsOnly }
  , { walsCode := "jpr", language := "Japreria", iso := "jru", value := .none }
  , { walsCode := "jaq", language := "Jaqaru", iso := "jqr", value := .uvularStopsOnly }
  ...
  , { walsCode := "kek", language := "K'ekchí", iso := "kek", value := .uvularStopsOnly }
  , { walsCode := "kab", language := "Kabardian", iso := "kbd", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "kal", language := "Kalami", iso := "gwc", value := .uvularStopsOnly }
  ...
  , { walsCode := "ket", language := "Ket", iso := "ket", value := .uvularStopsOnly }
  ...
  , { walsCode := "kgz", language := "Kirghiz", iso := "kir", value := .uvularStopsOnly }
  , { walsCode := "krb", language := "Kiribati", iso := "gil", value := .none }
  , { walsCode := "kss", language := "Kisi (Southern)", iso := "kss", value := .none }
  , { walsCode := "kiw", language := "Kiwai (Southern)", iso := "kjd", value := .none }
  , { walsCode := "klm", language := "Klamath", iso := "kla", value := .uvularStopsOnly }
  ...
  , { walsCode := "koh", language := "Kohumono", iso := "bcs", value := .none }
  ...
  , { walsCode := "kry", language := "Koryak", iso := "kpy", value := .uvularStopsOnly }
  , { walsCode := "kot", language := "Kota", iso := "kfe", value := .none }
  , { walsCode := "ktk", language := "Kotoko", iso := "aal", value := .none }
  ...
  , { walsCode := "kpa", language := "Kpan", iso := "kpk", value := .none }
  , { walsCode := "kpe", language := "Kpelle", iso := "xpe", value := .none }
  ...
  , { walsCode := "kmp", language := "Kunimaipa", iso := "kup", value := .uvularStopsOnly }
  , { walsCode := "krd", language := "Kurdish (Central)", iso := "ckb", value := .uvularStopsOnly }
  , { walsCode := "kur", language := "Kurukh", iso := "kru", value := .uvularContinuantsOnly }
  , { walsCode := "kut", language := "Kutenai", iso := "kut", value := .uvularStopsAndContinuants }
  , { walsCode := "kwa", language := "Kwaio", iso := "kwd", value := .none }
  , { walsCode := "kwk", language := "Kwakw'ala", iso := "kwk", value := .uvularStopsAndContinuants }
  , { walsCode := "kwo", language := "Kwoma", iso := "kmo", value := .none }
  , { walsCode := "lad", language := "Ladakhi", iso := "lbj", value := .none }
  , { walsCode := "lah", language := "Lahu", iso := "lhu", value := .uvularStopsOnly }
  , { walsCode := "lak", language := "Lak", iso := "lbe", value := .uvularStopsAndContinuants }
  , { walsCode := "lkt", language := "Lakhota", iso := "lkt", value := .none }
  , { walsCode := "lkk", language := "Lakkia", iso := "lbc", value := .none }
  ...
  , { walsCode := "lez", language := "Lezgian", iso := "lez", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "lui", language := "Luiseño", iso := "lui", value := .uvularStopsOnly }
  , { walsCode := "luo", language := "Luo", iso := "luo", value := .none }
  , { walsCode := "lus", language := "Lushootseed", iso := "lut", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "mak", language := "Makah", iso := "myh", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "mgg", language := "Mangghuer", iso := "mjg", value := .uvularStopsOnly }
  ...
  , { walsCode := "mar", language := "Maricopa", iso := "mrc", value := .uvularStopsOnly }
  ...
  , { walsCode := "mxm", language := "Mixtec (Molinos)", iso := "mig", value := .none }
  , { walsCode := "mog", language := "Moghol", iso := "mhj", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "nax", language := "Naxi", iso := "nxq", value := .uvularContinuantsOnly }
  ...
  , { walsCode := "nap", language := "Neo-Aramaic (Persian Azerbaijan)", iso := "trg", value := .uvularStopsAndContinuants }
  , { walsCode := "nep", language := "Nepali", iso := "npi", value := .none }
  , { walsCode := "new", language := "Newari (Kathmandu)", iso := "new", value := .none }
  , { walsCode := "nez", language := "Nez Perce", iso := "nez", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "niv", language := "Nivkh", iso := "niv", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "nuu", language := "Nuuchahnulth", iso := "nuk", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "ogb", language := "Ogbia", iso := "ogb", value := .none }
  , { walsCode := "oji", language := "Ojibwa (Eastern)", iso := "", value := .none }
  , { walsCode := "ond", language := "Oneida", iso := "one", value := .none }
  , { walsCode := "orm", language := "Ormuri", iso := "oru", value := .uvularContinuantsOnly }
  ...
  , { walsCode := "pai", language := "Paiwan", iso := "pwn", value := .uvularStopsOnly }
  , { walsCode := "pnr", language := "Panare", iso := "pbh", value := .none }
  , { walsCode := "puk", language := "Parauk", iso := "prk", value := .none }
  , { walsCode := "psh", language := "Pashto", iso := "pst", value := .uvularContinuantsOnly }
  ...
  , { walsCode := "prs", language := "Persian", iso := "pes", value := .uvularStopsOnly }
  ...
  , { walsCode := "pso", language := "Pomo (Southeastern)", iso := "pom", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "qco", language := "Quechua (Cochabamba)", iso := "quh", value := .uvularStopsOnly }
  , { walsCode := "qui", language := "Quileute", iso := "qui", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "rtk", language := "Rotokas", iso := "roo", value := .none }
  , { walsCode := "ruk", language := "Rukai (Tanan)", iso := "dru", value := .none }
  , { walsCode := "rus", language := "Russian", iso := "rus", value := .none }
  , { walsCode := "rut", language := "Rutul", iso := "rut", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "sel", language := "Selknam", iso := "ona", value := .uvularStopsOnly }
  , { walsCode := "skp", language := "Selkup", iso := "sel", value := .uvularStopsOnly }
  , { walsCode := "sml", language := "Semelai", iso := "sza", value := .none }
  , { walsCode := "snd", language := "Senadi", iso := "sef", value := .none }
  ...
  , { walsCode := "shu", language := "Shuswap", iso := "shs", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "som", language := "Somali", iso := "som", value := .uvularStopsOnly }
  , { walsCode := "soq", language := "Soqotri", iso := "sqt", value := .none }
  , { walsCode := "sor", language := "Sora", iso := "srb", value := .none }
  , { walsCode := "spa", language := "Spanish", iso := "spa", value := .none }
  , { walsCode := "squ", language := "Squamish", iso := "squ", value := .uvularStopsAndContinuants }
  , { walsCode := "sre", language := "Sre", iso := "kpm", value := .none }
  , { walsCode := "sue", language := "Suena", iso := "sue", value := .none }
  , { walsCode := "sui", language := "Sui", iso := "swi", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "tmp", language := "Tampulma", iso := "tpm", value := .none }
  , { walsCode := "tok", language := "Tarok", iso := "yer", value := .none }
  , { walsCode := "tas", language := "Tashlhiyt", iso := "shi", value := .none }
  , { walsCode := "tsg", language := "Tausug", iso := "tsg", value := .none }
  , { walsCode := "teh", language := "Tehuelche", iso := "teh", value := .uvularStopsOnly }
  ...
  , { walsCode := "tli", language := "Tlingit", iso := "tli", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "dts", language := "Toro So", iso := "dts", value := .none }
  , { walsCode := "tpa", language := "Totonac (Papantla)", iso := "top", value := .uvularStopsOnly }
  , { walsCode := "tru", language := "Trumai", iso := "tpy", value := .none }
  ]

private def allData_1 : List Datapoint :=
  [ { walsCode := "tsi", language := "Tsimshian (Coast)", iso := "tsi", value := .uvularStopsOnly }
  , { walsCode := "tso", language := "Tsou", iso := "tsu", value := .none }
  , { walsCode := "ttu", language := "Tsova-Tush", iso := "bbl", value := .uvularStopsAndContinuants }
  , { walsCode := "tug", language := "Tuareg (Ahaggar)", iso := "thv", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "uzn", language := "Uzbek (Northern)", iso := "uzn", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "wch", language := "Wichí", iso := "mzh", value := .uvularStopsOnly }
  , { walsCode := "wmu", language := "Wik Munkan", iso := "wim", value := .none }
  , { walsCode := "win", language := "Wintu", iso := "wnw", value := .uvularStopsAndContinuants }
  ...
  , { walsCode := "yko", language := "Yukaghir (Kolyma)", iso := "yux", value := .uvularStopsAndContinuants }
  , { walsCode := "ytu", language := "Yukaghir (Tundra)", iso := "ykg", value := .uvularStopsAndContinuants }
  , { walsCode := "yul", language := "Yulu", iso := "yul", value := .none }
  , { walsCode := "yus", language := "Yupik (Siberian)", iso := "ess", value := .uvularStopsAndContinuants }
...
theorem count_none :
    (allData.filter (·.value == .none)).length = 470 := by native_decide
theorem count_uvularStopsOnly :
    (allData.filter (·.value == .uvularStopsOnly)).length = 38 := by native_decide
theorem count_uvularContinuantsOnly :
    (allData.filter (·.value == .uvularContinuantsOnly)).length = 11 := by native_decide
theorem count_uvularStopsAndContinuants :
    (allData.filter (·.value == .uvularStopsAndContinuants)).length = 48 := by native_decide
