...
private def allData_0 : List Datapoint :=
  ...
  , { walsCode := "aik", language := "Aikaná", iso := "tba", value := .highAndMid }
  ...
  , { walsCode := "alb", language := "Albanian", iso := "sqi", value := .highOnly }
  , { walsCode := "aea", language := "Aleut (Eastern)", iso := "ale", value := .none }
  ...
  , { walsCode := "aze", language := "Azerbaijani", iso := "", value := .highAndMid }
  ...
  , { walsCode := "bsk", language := "Bashkir", iso := "bak", value := .highAndMid }
  ...
  , { walsCode := "bre", language := "Breton", iso := "bre", value := .highAndMid }
  ...
  , { walsCode := "cnt", language := "Cantonese", iso := "yue", value := .highAndMid }
  ...
  , { walsCode := "chq", language := "Chinantec (Quiotepec)", iso := "chq", value := .highAndMid }
  ...
  , { walsCode := "chv", language := "Chuvash", iso := "chv", value := .highAndMid }
  ...
  , { walsCode := "dgr", language := "Dagur", iso := "dta", value := .highOnly }
  ...
  , { walsCode := "eja", language := "Ejagham", iso := "etu", value := .highOnly }
  ...
  , { walsCode := "fin", language := "Finnish", iso := "fin", value := .highAndMid }
  , { walsCode := "fre", language := "French", iso := "fra", value := .highAndMid }
  , { walsCode := "ful", language := "Fulniô", iso := "fun", value := .none }
  , { walsCode := "fur", language := "Fur", iso := "fvr", value := .none }
  , { walsCode := "fuz", language := "Fuzhou", iso := "cdo", value := .highAndMid }
  ...
  , { walsCode := "ger", language := "German", iso := "deu", value := .highAndMid }
  ...
  , { walsCode := "hop", language := "Hopi", iso := "hop", value := .midOnly }
  ...
  , { walsCode := "hun", language := "Hungarian", iso := "hun", value := .highAndMid }
  , { walsCode := "hzb", language := "Hunzib", iso := "huz", value := .none }
  , { walsCode := "hup", language := "Hupa", iso := "hup", value := .none }
  , { walsCode := "iaa", language := "Iaai", iso := "iai", value := .highAndMid }
  ...
  , { walsCode := "kgz", language := "Kirghiz", iso := "kir", value := .highAndMid }
  ...
  , { walsCode := "lak", language := "Lak", iso := "lbe", value := .none }
  ...
  , { walsCode := "lep", language := "Lepcha", iso := "lep", value := .midOnly }
  , { walsCode := "lez", language := "Lezgian", iso := "lez", value := .highOnly }
  ...
  , { walsCode := "mlk", language := "Malakmalak", iso := "mpb", value := .midOnly }
  , { walsCode := "mla", language := "Mambila", iso := "", value := .none }
  , { walsCode := "mnc", language := "Manchu", iso := "mnc", value := .midOnly }
  , { walsCode := "mnd", language := "Mandarin", iso := "cmn", value := .highOnly }
  ...
  , { walsCode := "mme", language := "Mari (Meadow)", iso := "mhr", value := .highAndMid }
  ...
  , { walsCode := "nbk", language := "Natügu", iso := "ntu", value := .highAndMid }
  , { walsCode := "nav", language := "Navajo", iso := "nav", value := .none }
  , { walsCode := "nax", language := "Naxi", iso := "nxq", value := .highOnly }
  ...
  , { walsCode := "nga", language := "Nganasan", iso := "nio", value := .highOnly }
  ...
  , { walsCode := "nor", language := "Norwegian", iso := "nor", value := .highAndMid }
  , { walsCode := "nun", language := "Nung (in Vietnam)", iso := "nut", value := .none }
  , { walsCode := "nug", language := "Nunggubuyu", iso := "nuy", value := .none }
  , { walsCode := "nuu", language := "Nuuchahnulth", iso := "nuk", value := .none }
  ...
  , { walsCode := "qco", language := "Quechua (Cochabamba)", iso := "quh", value := .none }
  ...
  , { walsCode := "rut", language := "Rutul", iso := "rut", value := .none }
  ...
  , { walsCode := "skp", language := "Selkup", iso := "sel", value := .highAndMid }
  ...
  , { walsCode := "tib", language := "Tibetan (Standard Spoken)", iso := "bod", value := .highAndMid }
...
private def allData_1 : List Datapoint :=
  ...
  , { walsCode := "tuv", language := "Tuvan", iso := "tyv", value := .highAndMid }
  ...
  , { walsCode := "war", language := "Wari'", iso := "pav", value := .highAndMid }
  ...
  , { walsCode := "wuc", language := "Wu", iso := "wuu", value := .highOnly }
  , { walsCode := "ygr", language := "Yagaria", iso := "ygr", value := .none }
  , { walsCode := "yag", language := "Yagua", iso := "yad", value := .none }
  , { walsCode := "ykt", language := "Yakut", iso := "sah", value := .highAndMid }
  ...
  , { walsCode := "yko", language := "Yukaghir (Kolyma)", iso := "yux", value := .midOnly }
  , { walsCode := "ytu", language := "Yukaghir (Tundra)", iso := "ykg", value := .midOnly }
...
theorem count_none :
    (allData.filter (·.value == .none)).length = 525 := by native_decide
theorem count_highAndMid :
    (allData.filter (·.value == .highAndMid)).length = 23 := by native_decide
theorem count_highOnly :
    (allData.filter (·.value == .highOnly)).length = 8 := by native_decide
theorem count_midOnly :
