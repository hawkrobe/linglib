...
/-!
# Inquisitive Content — mention-some / mention-all answerhood
...
quantify over the alternatives `alt P` of an inquisitive content; for
the limit case where alternatives don't exist
...
`Core/Inquisitive/Decidable.lean`.
-/
